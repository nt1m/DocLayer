function addItem(data) {
	$(".doclist").prepend("<li ripple id='" + data.id + "'><span class='item-text'>" + data.title + "<span class='secondary-text'>" + data.description + "</span></span><i class='icon-open-in-browser item-action'></i></li>");
}
